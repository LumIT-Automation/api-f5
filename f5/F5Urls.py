...
urlpatterns = [
    ...
    path('<int:sourceAssetId>/<int:destinationAssetId>/asm/policy-merge/<str:sourcePolicyId>/<str:destinationPolicyId>/', PolicyMerge.F5PolicyMergeController.as_view(), name='f5-asm-policy-merge'),
