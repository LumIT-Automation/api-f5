...
class F5VirtualServerSerializer(serializers.Serializer):
    ...
    pool = serializers.CharField(max_length=255, required=False, allow_blank=True)
    serversslUseSni = serializers.CharField(max_length=255, required=False)
    poolReference = F5VirtualServerPoolReferenceSerializer(required=False, allow_null=True)
